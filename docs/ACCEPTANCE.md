...
> 更新时间:阶段 1 后端完成、H5 前端开发中

| # | PRD 验收标准 | 状态 | 实现位置 | 验证方式 |
|---|---|---|---|---|
| 1 | 七个端全部可访问可操作 | 🟡 部分 | 农户端/消费端 H5(开发中);银行/保险/品牌运营/管理/政府端 API 已就绪,Web 界面待阶段 2 | frontend/ + /docs |
...
| 4 | 消费者可认养一块田 | ✅ | GET /api/adoption/plots + POST /api/adoption/orders(模拟支付即 PAID) | pytest test_consumer_adoption |
